//! Shared orchestrator wiring for PAGI add-on UIs.
//! Uses current_dir()-relative paths (bare-metal).
...
/// Builds an Orchestrator with full skill registry and blueprint, using paths under `storage_dir`.
